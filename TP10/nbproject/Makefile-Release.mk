...
${OBJECTDIR}/Puertos.o: Puertos.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Puertos.o Puertos.c
...
${TESTDIR}/tests/tests.o: tests/tests.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/tests.o tests/tests.c
...
${OBJECTDIR}/Puertos_nomain.o: ${OBJECTDIR}/Puertos.o Puertos.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Puertos_nomain.o Puertos.c;\
	else  \
